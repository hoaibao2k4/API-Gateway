...
import com.example.gateway.dto.response.MessageResponse;
...
public class AuthController {
  ...
  @GetMapping("/me")
  public Mono<MyInfoResponse> getUserClaims(@AuthenticationPrincipal OidcUser oidcUser) {
    return authService.getMyInfo(oidcUser);
  }

  @PostMapping("/logout-all")
  public Mono<ResponseEntity<MessageResponse>> logoutAllDevices(
    ...
    return authService.logoutAllDevices(authorizedClient, oidcUser)
        ...
        .then(Mono.just(ResponseEntity.ok(MessageResponse.builder()
